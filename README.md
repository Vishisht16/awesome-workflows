...
| Icon | Level | Meaning |
|:----:|-------|---------|
| ✅ | **Drop-in** | Copy the file, commit, done. Zero changes required. |
| 🔧 | **Configurable** | Works immediately but review the config values (timeouts, labels, thresholds). |
| ⚙️ | **Needs Setup** | Requires secrets, API keys, webhook URLs, or external service configuration. |

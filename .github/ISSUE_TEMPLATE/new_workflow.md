...
Where should this workflow live in our repository structure?
_Example: `github-actions/repo-management/`_
...
### Have you tested it?
- [ ] Yes, I have tested this workflow in a real repository and confirmed it works as expected.

### Are you planning to submit a PR for this?
- [ ] Yes, I will open a Pull Request!
- [ ] No, I'm just suggesting the idea for someone else to build.
